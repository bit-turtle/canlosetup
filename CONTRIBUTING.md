...
Create a file in the [`service/`](service) directory called `CANHAT.sh` and write a bash script which brings up the CAN HAT. Some generic functions are available to use in the [`common/canlosetup.txt`](common/canlosetup.txt) file
